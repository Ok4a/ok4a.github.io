...
writeHTML(Ent, 'Brætspil', csv_name, compress_series_entries=True, startCompressed=True)
for series in Ser.values():
...
writeHTML(Ent, 'Bøger', csv_name, compress_series_entries=True, startCompressed=True)
for series in Ser.values():
    writeHTML(series.entries, series.name, f'{series.name}_{csv_name}', compress_series_entries=True)
